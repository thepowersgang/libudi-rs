...
");
    ...
    ::udi::log::trace_write(&context, ::udi::log::TraceEvent::LocalProcEntry, 1.into(), udiprops::Msg101, (1234,));
}

fn get_udi_init() -> &'static ::udi::ffi::init::udi_init_t {
    static ONCE: ::std::sync::OnceLock<&'static ::udi::ffi::init::udi_init_t> = ::std::sync::OnceLock::new();
    ONCE.get_or_init(|| {
