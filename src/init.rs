...
pub trait Driver: 'static {
	...
	fn init(cb: crate::CbRef<crate::ffi::meta_mgmt::udi_usage_cb_t>, resouce_level: u8) -> Self::Future_init<'_>;
...
impl ffi::meta_mgmt::udi_mgmt_ops_t {
    ...
    pub const unsafe fn for_driver<T: Driver>() -> Self {
        ...
        {
            let job = MgmtStateInit::<T> { inner_future: T::init(crate::CbRef::new(cb), resource_level) };
